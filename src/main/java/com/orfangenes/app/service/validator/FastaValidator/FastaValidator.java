...
public class FastaValidator
{
	 ...
	 */
	public Map<String, String> validate(String filename) throws java.io.FileNotFoundException, java.io.IOException, FastaValidatorException, FastaHandlingException
	{
		validate(new StringReader(filename));
