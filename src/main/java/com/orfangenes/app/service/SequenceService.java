...
//        combineBlastResults(sequenceBatches.size());
    ...
    private void runBlastCommands(int maxTargetSeqs, int evalue, String analysisId, Boolean isPsiBlast, Integer numIteration) {
        ...
        blastCommandRunner.setNumIteration(numIteration);
