...
//
  ...
  public TaxTree(String rankedlineage, List<Integer> blastHitsTaxIDs) {
...
//  }
//
//  private void processTaxonomyIDLineage(String nameString) {
//    String[] lineData = nameString.split("\t\\|\t");
//    int taxonomyId = Integer.parseInt(lineData[0]);
//    String lineage = lineData[1].substring(0, lineData[1].length()-2);
//
//    List<Integer> taxIdList = null;
//    try {
//      Pattern pattern = Pattern.compile(" ");
//      taxIdList = pattern.splitAsStream(lineage)
//              .map(Integer::valueOf)
//              .collect(Collectors.toList());
//    } catch (Exception e) {
//      log.warn("Error occured in processing taxIdLineage file - taxID : " + taxonomyId);
//    }
//    taxIdLineage.put(taxonomyId, taxIdList);
//  }
//
